      ...
      {showBox && (
        <div className="absolute bg-black bg-opacity-40 w-[200px] top-full right-[10%] mt-2 p-4 rounded shadow-lg">
          <div className=" flex flex-col items-start gap-2">
            <button className=" w-full flex items-center justify-between px-2 py-1 text-left rounded text-[#ffffffc9] hover:text-white hover:bg-[#ffffff33]">
              Register <CgProfile className=" text-xl" />
            </button>
            <button className=" mt-2 flex items-center justify-between  w-full px-2 py-1 text-left rounded text-[#ffffffc9] hover:text-white hover:bg-[#ffffff33]">
